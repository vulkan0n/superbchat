<template>
  <div
    class="rounded-lg shadow-lg p-3 md:p-8 w-full m-auto bg-white overflow-auto overflow-ellipsis"
  >
    <h1 class=" text-m font-bold mb-2 mr-2">Privacy Policy</h1>
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          this Agreement) refers to Superbchat.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          <strong>Website</strong> refers to Superbchat, accessible from
          <a
            href="https://superbchat.cash"
            rel="external nofollow noopener"
            target="_blank"
            >https://superbchat.cash</a
          >
        </p>
      </li>
      <li>
    ...
    <ul>
      <li>By email: superbchat.cash@gmail.com</li>
    </ul>
  </div>
</template>
